...
export default async function AdminOverview() {
  ...
  const stats = [
    { label: "Subscriptions", value: subscriptions[0].active, sub: `${subscriptions[0].count} total`, href: "/admin/accounts" },
    { label: "Sites", value: sites[0].count, href: "/admin/accounts" },
