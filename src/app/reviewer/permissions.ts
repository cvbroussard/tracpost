...
export const PERMISSIONS: ReviewerPermission[] = [
  ...
  },
  {
    ...
    testSteps: [
      "Demonstrated implicitly during the ads_management test above — the connected Ad Account is BM-owned and the TracPost platform successfully creates a campaign on it.",
    ],
...
export const TEST_CREDENTIALS = {
  ...
  notes:
    "Subscriber account 'test2' is on the enterprise tier with one site provisioned. " +
    "The reviewer logs in with the credentials above to act as the subscriber. " +
