  ...
  return (
    <>
      ...
      <section className="ws-hero">
        <img src={data.heroImage} alt="" className="ws-hero-bg" />
        <div className="ws-hero-overlay">
          <div className="ws-container ws-hero-content">
            ...
            <div className="ws-hero-actions">
              <a href={data.ctaHref} className="ws-btn ws-btn-primary">{data.ctaText}</a>
              <a href={data.projectsUrl} className="ws-btn ws-btn-outline" style={{ color: "#fff", borderColor: "rgba(255,255,255,0.4)" }}>
                View Our Work
              </a>
            </div>
          </div>
        ...
        <div className="ws-container">
          ...
          <div className="ws-gallery">
            {data.galleryImages.slice(0, 6).map((img, i) => (
              <a key={i} href={data.projectsUrl} className="ws-gallery-item">
                <img src={img.url} alt={img.alt} />
              </a>
            ))}
          </div>
          <div style={{ textAlign: "center", marginTop: 32 }}>
            <a href={data.projectsUrl} className="ws-btn ws-btn-outline">See All Projects</a>
          </div>
        </div>
      </section>
      ...
      <section className="ws-section ws-cta-section">
        <div className="ws-container" style={{ textAlign: "center" }}>
          <h2 className="ws-section-title" style={{ marginBottom: 16 }}>Ready to Get Started?</h2>
          <p className="ws-section-subtitle" style={{ margin: "0 auto 32px", maxWidth: 500 }}>
            Let&apos;s talk about your project. We&apos;ll walk through what&apos;s involved and give you a clear picture of what to expect.
          </p>
          <a href={data.contactHref} className="ws-btn ws-btn-primary">Contact Us</a>
        </div>
      </section>
