        ...
        <table className="w-full">
          ...
          <tbody>
            {tokenHealth.map((t) => {
              ...
              return (
                <tr key={`${t.account_name}-${t.platform}`} className="border-b border-border last:border-0 transition-colors hover:bg-surface-hover">
                  ...
                  <td className="py-3 pr-4 text-sm text-muted">{t.site_name}</td>
            ...
            {tokenHealth.length === 0 && (
              <tr>
                <td colSpan={5} className="py-8 text-center text-muted">No social accounts</td>
              </tr>
            )}
          </tbody>
        </table>
              ...
              <div key={f.id} className="border-b border-border py-4 last:border-0">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted">{f.account_name} ({f.platform}) — {f.site_name}</p>
                  </div>
