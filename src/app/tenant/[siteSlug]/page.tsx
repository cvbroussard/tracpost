    ...
    <MarketingShell ctx={ctx} activePage="home">
        ...
        <div className="ws-hero-overlay">
          <div className="ws-container ws-hero-content">
            ...
            <div className="ws-hero-actions">
              <a href={`${prefix}/contact`} className="ws-btn ws-btn-primary">{data.ctaText}</a>
              <a
                href={`${prefix}/work`}
        ...
        <section className="ws-section-alt">
          <div className="ws-container">
            ...
            <div style={{ textAlign: "center", marginTop: 32 }}>
              <a href={`${prefix}/work`} className="ws-btn ws-btn-outline">See All Projects</a>
            </div>
          </div>
        </section>
      )}
      ...
      <section className="ws-section ws-cta-section">
        <div className="ws-container" style={{ textAlign: "center" }}>
          ...
          <a href={`${prefix}/contact`} className="ws-btn ws-btn-primary">Contact Us</a>
        </div>
      </section>
