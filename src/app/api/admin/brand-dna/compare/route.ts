 ...
 * brand_dna (v2 envelope). After Phase A + Phase B retire both columns, the
 * comparison is meaningless — both are gone. SQL refs here are INTENTIONALLY
 * LEFT BROKEN per fail-aloud. The route retires entirely with /ops/brand UI
 * when that surface is rewired for the brand-identity catalog era.
 */
