    ...
    subs: [
      {
        ...
        path: "/integrations",
        children: [
          { label: "Facebook", path: "/integrations/facebook" },
          { label: "Instagram", path: "/integrations/instagram" },
          { label: "Google Business", path: "/integrations/google-business" },
          { label: "YouTube", path: "/integrations/youtube" },
          { label: "TikTok", path: "/integrations/tiktok" },
          { label: "LinkedIn", path: "/integrations/linkedin" },
          { label: "X (Twitter)", path: "/integrations/x-twitter" },
          { label: "Pinterest", path: "/integrations/pinterest" },
        ],
      },
